...
const config = {
    ...
    minimumTimeBetweenStars: 70,
    minimumDistanceBetweenStars: 30,
    glowDuration: 50,
    maximumGlowPointSpacing: 20,
    colors: [
        "75 231 255",
        "46 144 255",
        "117 48 255",
    ...
    sizes: [
        "0.91rem", "0.92rem", "0.93rem", "0.94rem", "1.4rem",
        "0.91rem", "0.92rem", "0.93rem", "0.94rem", "1.4rem",
        "1rem", "0.6rem", "2rem", "1.5rem", "0.1rem", "0.899999929rem",
        "1rem", "0.6rem", "2rem", "1.5rem", "0.1rem", "0.899999929rem",
        "1rem", "0.6rem", "2rem", "1.5rem", "0.1rem", "0.899999929rem",
        "0.5rem", "1.7rem", "1.2rem", "1.3rem"],
    animations: ["fall-1", "fall-2", "fall-3", "fall-4", "fall-5", "fall-6"]
}
...
const createStar = position => {
    ...
    star.className = "star fa-solid fa-solid fa-bowl-food";
